unitree_go2_flat_cfg = {
    ...
    'policy': {
        ...
        #'actor_hidden_dims': [512, 256, 128],       # ← mettre les mêmes dimensions que le modèle sauvegardé
        #'critic_hidden_dims': [512, 256, 128],      # ← pareil ici
        'activation': 'elu'
    },
    'algorithm': {
        'class_name': 'PPO',
